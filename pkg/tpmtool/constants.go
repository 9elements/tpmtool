...
// TPMIAlgHash is the TPM hash algorithm
type TPMIAlgHash uint16

// We only define TPM hash algorithms here we use
const (
	// TPMAlgError is an algorithm error
	TPMAlgError TPMIAlgHash = 0x0000
	// TPMAlgSha
	TPMAlgSha     TPMIAlgHash = 0x0004
	TPMAlgSha256  TPMIAlgHash = 0x000B
	TPMAlgSha384  TPMIAlgHash = 0x000C
	TPMAlgSha512  TPMIAlgHash = 0x000D
	TPMAlgSm3s256 TPMIAlgHash = 0x0012
)

// TPMIAlgHashSize is the TPM hash algorithm length
type TPMIAlgHashSize uint8

const (
	// TPMAlgShaSize SHA hash size
	TPMAlgShaSize TPMIAlgHashSize = 20
	// TPMAlgSha256Size SHA256 hash size
	TPMAlgSha256Size TPMIAlgHashSize = 32
	// TPMAlgSha384Size SHA384 hash size
	TPMAlgSha384Size TPMIAlgHashSize = 48
	// TPMAlgSha512Size SHA512 hash size
	TPMAlgSha512Size TPMIAlgHashSize = 64
	// TPMAlgSm3s256Size SM3-256 hash size
	TPMAlgSm3s256Size TPMIAlgHashSize = 32
)
